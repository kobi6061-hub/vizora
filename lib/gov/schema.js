...
const FIELDS = Object.freeze([
  ...
  'street',
  'houseNumber',
  'neighborhood',    // as published on the record — never inferred
  'block',           // גוש
  'parcel',          // חלקה
  'subParcel',       // תת-חלקה
  'lat',
  'lng',
  'projX',           // source-projected coordinates, verbatim, with the CRS
  'projY',           //   named in projCrs — no silent reprojection
  'projCrs',
  'propertyClass',   // residential | land | commercial | unknown (from source text)
